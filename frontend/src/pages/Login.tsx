...
const LoginForm = memo(() => {
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      await dispatch(loginUser({ email, password, role: 'student' }));
      toast({
        title: t('Login Successful'),
        description: t('Welcome back to Tree8 Global!'),
        status: 'success',
        duration: 3000,
        isClosable: true,
        position: 'top-right',
  ...
  }, [email, password, dispatch, toast, t, navigate]);
        ...
        >
          ...
          <VStack spacing={4}>
            ...
            <Text
              ...
              mb={2}
            >
              {t('Login to continue your learning journey')}
            </Text>
          </VStack>
